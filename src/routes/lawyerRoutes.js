...
const { addLawyer,initiateLawyerRegistration, registerLawyer, getAllLawyers } = require('../controllers/lawyerController');
...
router.post('/register-complete', registerLawyer);
